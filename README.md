...
调用地址
>POST > [域名]/shiyou/update_sentence
...
| target_id      | string          | 必选            |    "demo"                             | 目标id                    |
| source      | string          | 必选            |    "H5"                             | 来源(区分前端)                    |
| original_answer      | string          | 必选            |    "我叫张三"                             | 历史文档数据                    |
| update_answer      | string          | 必选            |    "我叫李四"                             | 用户输入替换文档数据                    |
...
调用地址
>POST > [域名]/shiyou/select_sentence
...
| target_id      | string          | 必选            |    "demo"                             | 目标id                    |
| source      | string          | 必选            |    "H5"                             | 来源(区分前端)                    |
| question      | string          | 必选            |    "你叫什么？"                             | 用户输入问题                    |
